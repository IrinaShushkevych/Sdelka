...
//print_r($r3);	
//  формування запиту у випадку коли is_checks=1 (необхідно отримати вибірку для вибору даних)	
if ($r2[0]['is_checks'] ===1 ){	
...
//  формування запиту у випадку коли is_checks=0 (необхідно отримати вибірку для вводу даних)
    $select = '';
